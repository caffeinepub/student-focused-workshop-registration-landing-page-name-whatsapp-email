...
import type { Registration as _Registration, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getRegistrationByNumber(arg0: string): Promise<Registration | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getRegistrationByNumber(arg0);
...
function from_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Registration]): Registration | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        registeredNumber: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.registeredNumber))
    };
}
...
function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        registeredNumber: value.registeredNumber ? candid_some(value.registeredNumber) : candid_none()
    };
}
